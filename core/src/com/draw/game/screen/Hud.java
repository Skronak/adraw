...
public class Hud implements Disposable {
    ...
    public Hud(MainScreen playScreen) {
        ...
        Texture texture = new Texture(Gdx.files.internal("bat1_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test1 = new Image(texture);
        test1.addListener(new HudButtonListener(this,test1));
        texture = new Texture(Gdx.files.internal("bat2_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test2 = new Image(texture);
        test2.addListener(new HudButtonListener(this,test2));
        texture = new Texture(Gdx.files.internal("bat3_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test3 = new Image(texture);
        test3.addListener(new HudButtonListener(this,test3));
        texture = new Texture(Gdx.files.internal("bat4_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test4 = new Image(texture);
        test4.addListener(new HudButtonListener(this,test4));
        texture = new Texture(Gdx.files.internal("bat5_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test5 = new Image(texture);
        test5.addListener(new HudButtonListener(this,test5));
        texture = new Texture(Gdx.files.internal("bat5_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test6 = new Image(texture);
        test6.addListener(new HudButtonListener(this,test6));
        texture = new Texture(Gdx.files.internal("bat5_icon.png"));
        texture.setFilter(Texture.TextureFilter.Linear, Texture.TextureFilter.Linear);
        test7 = new Image(texture);
        test7.addListener(new HudButtonListener(this,test7));
