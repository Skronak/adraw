...
public class CustomVerticalGroup extends VerticalGroup {
    ...
    public CustomVerticalGroup reverse () {
        this.reverse = true;
        return this;
    }

    /** If true, the children will be displayed last to first. */
    public CustomVerticalGroup reverse (boolean reverse) {
    ...
    public CustomVerticalGroup space (float space) {
        this.space = space;
        return this;
    }
    ...
    public CustomVerticalGroup wrapSpace (float wrapSpace) {
    ...
    public CustomVerticalGroup pad (float pad) {
        padTop = pad;
        padLeft = pad;
        padBottom = pad;
        padRight = pad;
    ...
    public CustomVerticalGroup pad (float top, float left, float bottom, float right) {
        padTop = top;
        padLeft = left;
        padBottom = bottom;
        padRight = right;
    ...
    public CustomVerticalGroup padTop (float padTop) {
        this.padTop = padTop;
        return this;
    }

    public CustomVerticalGroup padLeft (float padLeft) {
        this.padLeft = padLeft;
        return this;
    }

    public CustomVerticalGroup padBottom (float padBottom) {
        this.padBottom = padBottom;
        return this;
    }

    public CustomVerticalGroup padRight (float padRight) {
    ...
    public CustomVerticalGroup left () {
        align |= Align.left;
        align &= ~Align.right;
        return this;
    }
    ...
    public CustomVerticalGroup bottom () {
        align |= Align.bottom;
        align &= ~Align.top;
        return this;
    }
    ...
    public CustomVerticalGroup right () {
        align |= Align.right;
        align &= ~Align.left;
        return this;
    }
    ...
    public CustomVerticalGroup fill () {
        fill = 1f;
        return this;
    }

    /** @param fill 0 will use preferred height. */
    public CustomVerticalGroup fill (float fill) {
        this.fill = fill;
        return this;
    }
    ...
    public CustomVerticalGroup grow () {
        expand = true;
        fill = 1;
        return this;
    }
     ...
     * width. */
    public CustomVerticalGroup wrap () {
        wrap = true;
        return this;
    }

    public CustomVerticalGroup wrap (boolean wrap) {
        this.wrap = wrap;
        return this;
    }
    ...
    public CustomVerticalGroup columnRight () {
        columnAlign |= Align.right;
        columnAlign &= ~Align.left;
        return this;
    }
